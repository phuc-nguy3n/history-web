  ...
  central: {
    ...
    posts: [
      ...
      },
      {
        ...
        content2: "Sau khi vua Trần dời đô từ Thăng Long vào Thanh Hóa và giết hàng loạt quần thần trung thành với nhà Trần, tháng 2 năm 1400, Hồ Quý Ly truất ngôi của cháu ngoại là Trần Thiếu Đế, tự lên làm vua lấy quốc hiệu là Đại Ngu (Ngu có nghĩa Yên Vui), lập nên nhà Hồ.Hổ Quý Ly từ khi nắm quyền lực của triều Trần cho đến khi sáng lập vương triều mới đã ban hành và thực thi một loạt chính sách cải cách về các mặt chính trị, kinh tế, tài chính, văn hóa, giáo dục nhằm khắc phục cuộc khủng hoảng của chế độ quân chủ cuối triều Trần, củng cố chính quyền trung ương và chuẩn bị cho cuộc kháng chiến chống Minh. Trong lịch sử chế độ quân chủ Việt Nam, Hồ Quý Ly là một nhà cải cách lớn với một hệ thống chính sách và biện pháp khá toàn diện, táo bạo.",
      },
    ],
  },
  southern: {
    ...
    posts: [
      {
        ...
        content:"Công trình do viên thống đốc Pháp tại miền Nam Việt Nam là La Grandière đặt viên đá đầu tiên khởi công xây dựng ngày 23/2/1868 và hoàn tất vào năm 1871. Từ 1887 – 1945, nhiều đời toàn quyền Pháp đã sử dụng dinh thự này làm nơi ở và làm việc trong suốt thời kỳ xâm lược Ðông Dương.",
        img1: "",
        img2: "",
        content2: "",
      },
