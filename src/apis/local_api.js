/*
 * All the data for the app is kept here.
 * In a real world app, this data would likely be fetched from a server.
 * To keep this example simple, all data is stored as a big object.
 */
